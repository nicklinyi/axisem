...
else if ($1 == 'irene') then

    echo  '#\!/bin/bash -l' > axisem_mesher.batch
    echo "#MSUB -r axisem_mesher " >> axisem_mesher.batch
    echo "#MSUB -q  skylake  " >> axisem_mesher.batch
    echo "#MSUB -A  racoe003 " >> axisem_mesher.batch
    echo "#MSUB -m  scratch,work,store ">> axisem_mesher.batch
    echo "#MSUB -n 1" >> axisem_mesher.batch
    echo "#MSUB -N 1" >> axisem_mesher.batch
    echo "#MSUB -T 1800 " >> axisem_mesher.batch
    echo "#MSUB -e  axisem_mesher%I.e" >> axisem_mesher.batch
    echo "#MSUB -o  axisem_mesher%I.e" >> axisem_mesher.batch
    echo "#MSUB -x " >> axisem_mesher.batch
    echo "set -x" >> axisem_mesher.batch
    echo ' cd ${BRIDGE_MSUB_PWD}' >> axisem_mesher.batch
    echo " ccc_mprun ./xmesh > OUTPUT" >> axisem_mesher.batch
    ccc_msub axisem_mesher.batch
